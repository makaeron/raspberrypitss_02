...
step3 = importlib.import_module("tml-solutions.myawesometmlsolutionml-c8df.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-myawesometmlsolutionml-c8df")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_dag-myawesometmlsolutionml-c8df",
