...
step3 = importlib.import_module("tml-solutions.tml-server-v1-plugin-c8df.tml_read_gRPC_step_3_kafka_producetotopic_dag-tml-server-v1-plugin-c8df")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_grpc_dag-tml-server-v1-plugin-c8df",
